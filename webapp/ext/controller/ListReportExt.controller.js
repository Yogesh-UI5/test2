sap.ui.define([
    ...
    return {
        getCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                var oCustomField1 = this.oView.byId("AggregatorID");
                if (oCustomField1) {
                    oCustomData.AggregatorID = oCustomField1.getSelectedKey();
                }
            }
        },
        restoreCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                if (oCustomData.AggregatorID) {
                    var oComboBox = this.oView.byId("AggregatorID");
                    oComboBox.setSelectedKey(
                        oCustomData.AggregatorID
                    );
                }
            }
        },
        ...
        custom: function(oEvent) {
        alert("Custom handler invoked.");
        }
    };
});